...
- [x] Explain what a token is used for.
  - [ ]string of cryptic text issued by the server to store on the client side to help with permission to access data.
- [x] What steps can you take in your web apps to keep your data secure?
  - [ ] don't store the key in a public file. Throw it in an ENV file. 
- [x] Describe how web servers work.
  - [ ] Computer connects to the internet ->  stores the code for different websites to be shared across the world at all times
